...
export const FORMATS: Record<FormatId, {
    ...
    gen9vgc2026regi: { label: '[Gen 9] VGC 2026 Reg I', maxTeamSize: 6, gameType: 'doubles' },
    gen9vgc2026f: { label: '[Gen 9] VGC Reg F (Legacy)', maxTeamSize: 6, gameType: 'doubles' },
...
export const CURRENT_VGC_FORMAT: FormatId = 'gen9vgc2026regi';
