export type PlaystyleIcon = "flame" | "wind" | "moon" | "shield" | "zap";
        ...
        playstyles: [
            {
                id: "damage-spam",
                icon: "flame",
                title: { en: "Damage Spam", es: "Daño explosivo" },
            ...
            },
            {
                id: "trick-room",
                icon: "moon",
                title: { en: "Trick Room", es: "Trick Room" },
    ...
    default: {
        ...
        playstyles: [
            ...
            },
            {
                id: "hyper-offense",
                icon: "zap",
                title: { en: "Hyper Offense", es: "Hiper Ofensiva" },
